function [nodal_coords,elem_quad_nodes]=write_rect_mesh(pid,dim_x,dim_y,Nnodes_x,Nnodes_y,z_height,id_offset,filename,permission)
...
coords=[coords(:,1)-dim_x/2 coords(:,2)-dim_y/2 coords(:,3)+z_height];
tc=zeros(Nnodes,1);
rc=zeros(Nnodes,1);
